<div align="center">
  <img src="https://cdn-icons-png.flaticon.com/512/3514/3514491.png" alt="SmartShop Logo" width="80" />
  <h1>SmartShop - Full-Stack MERN E-Commerce App</h1>
...
From the **root folder** `SmartShop/`, trigger a full install across environments:
```bash
npm run build
```
...
npm run seed
```
> **Seed Admin Access:** Email: `admin@gmail.com` | Password: `123456`
